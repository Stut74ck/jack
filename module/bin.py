...
def menu():
	tampil('''\rh
[===============================================]>
  __  __ ____  _____ _____ _____ _____ ____ _____ ____  _____                              |  \/  |  _ \|_   _| ____|_   _| ____/ ___| ____|  _ \| ____|
 | |\/| | |_) | | | |  _|   | | |  _|| |  _|  _| | | | |  _|
 | |  | |  _ < _| | | |___  | | | |__| |_| | |___| |_| | |___                              |_|  |_|_| \_(_)_| |_____| |_| |_____\____|_____|____/|_____|
\rk###########################################################
#             \rb*MULTY BRUTEFORCE FACEBOOK*\rk                 #
# \rhBY\rp                                             MR.teteGede \rk#
